...
duplicado ao GradientBoosting do MATH&ML — que já recebe saúde financeira
(fundamentos) e macro como **features cruas independentes do JOURNAL**.
...
sanidade leve**: se `abs(score_total − comp_noticia) > 0.25` (`_DIVERGENCIA_MAX`),
